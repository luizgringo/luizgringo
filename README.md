...
╔══════════════════════════════════════════════════════════════════╗
║  C:\> WHOIS luizgringo                                           ║
║  > Luiz Henrique Bueno · Senior Frontend Developer · Tech Lead   ║
...
- **Bachelor's** in Information Systems · **2 Postgraduate** degrees (Web Dev + UX & Agile) — *PUC Minas*
- **Tech Lead Program** — IFTL · **PSM I** — Scrum.org · **EF SET C2 Proficient**
- **Languages:** Portuguese (native) · English (C1) · Spanish (A1)
- Working with **GenAI tooling** every day — Claude, Cursor, ChatGPT, Copilot

> Whether solving complex technical challenges or leading a team, I'm passionate about delivering excellence — the kind users actually feel.
...
![Pinia](https://img.shields.io/badge/Pinia-FFD43B?style=flat-square&logo=pinia&logoColor=000)
...
![GraphQL](https://img.shields.io/badge/Apollo%20GraphQL-311C87?style=flat-square&logo=apollographql&logoColor=white)
...
![Copilot](https://img.shields.io/badge/GitHub%20Copilot-181717?style=flat-square&logo=githubcopilot&logoColor=white)
...
| --- | --- | --- |
| **[luizbueno.com](https://www.luizbueno.com)** | Next.js 16 · React 19 · TS · Tailwind v4 · Biome | Personal portfolio with a Norton Commander / DOS visual identity |
| **[Cactus Partners Dashboard](https://app.7k.partners/)** | Nuxt 4 · Vue 3 · TS · Tailwind · Pinia · Chart.js | Multi-tenant affiliate platform · PT/EN/ES · dynamic theming |
| **[Bet7K](https://7k.bet.br)** | Vue 3 · TS · Tailwind | iGaming platform front-end |
| **Brius for Acquisition** | Vue 3 · Vite · Pinia · Sass · Node | Architectural direction & tech leadership at ETUS |
| **Luther (GenAI bootstrap)** | Nuxt 3 · Strapi · Claude Sonnet · Cursor | AI-assisted CRUD scaffolding for Brius/ETUS systems |
| **[Globoplay TV](https://globoplay.globo.com)** | React · TS · CSS Modules · Apollo GraphQL | VOD app for Smart TVs · ~40M users |
| **Kyte Web** | React · Redux · Design System | E-commerce manager used by ~42K small retailers |
| **Cosmik Component Library** | React · TS · Rollup · Storybook | Reusable design-system library |
...
- **Postgraduate** — UX Design & Agile Frameworks (2022)
- **Postgraduate** — Web Application Development (2014)
- **Bachelor's Degree** — Information Systems (2012)
...
<p align="center">
  <sub><code>C:\> EXIT</code> — thanks for stopping by.</sub>
</p>
